...
//            . str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
    ...
    //$path_uri = substr($base_uri, 0, -1);
    //$path_uri = substr($path_uri, 1);
//} else {
//    $base_url = 'http://localhost/mailing-ad';
    //$base_uri = '/';
    //$path_uri = '';
...
$thumbs_base_path = '../ad-content/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
