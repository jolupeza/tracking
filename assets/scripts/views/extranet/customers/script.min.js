...
var c=b.split("/");spinner.spin(target);if(e=="all"){href_new=_root_+c[3]+"/"+c[4]+"/"+c[5]+"/"+c[6]+"/"+c[7]+"/"+c[8]+"/"+0+"/"+c[10];}else{href_new=_root_+c[3]+"/"+c[4]+"/"+c[5]+"/"+c[6]+"/"+c[7]+"/"+c[8]+"/"+e+"/"+c[10];
